                ...
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                    <div className="bg-gray-100 relative h-96 w-full group">
                         ...
                         <div className="absolute top-4 left-4">
                            <span className={`px-3 py-1.5 rounded-full text-sm font-medium text-white shadow-lg ${item.type === 'recipe' ? 'bg-orange-500' : 'bg-blue-500'}`}>
                    ...
                    <div className="p-8 md:p-12">
                        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6 mb-8 border-b pb-8">
                            <div>
                                <h1 className="text-4xl font-extrabold text-gray-900 mb-4">{item.title}</h1>
                                ...
                                {item.type === 'restaurant' && (
                                     <div className="bg-blue-50 rounded-xl p-6 border border-blue-100 sticky top-24">
                                        ...
                                        <div className="space-y-4 text-sm">
                                            <div>
                                                <span className="block text-blue-800 font-semibold">Location</span>
                                                <span className="text-gray-600">{item.location}</span>
                                            </div>
                                            <div>
                                                <span className="block text-blue-800 font-semibold">Price Range</span>
                                                <span className="text-gray-600">{item.priceRange === '$$$$' ? 'Luxury' : item.priceRange === '$$$' ? 'Expensive' : 'Moderate'} ({item.priceRange})</span>
                                            </div>
                                        </div>
                                    </div>
                                )}
